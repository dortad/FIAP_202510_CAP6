    ...
    match escolha:
        ...
        case 1:
            try:
                ...
                cadastro = f""" INSERT INTO petshop (tipo_pet, nome_pet, idade)
    ...
    # Flag para não executar a Aplicação
        ...
        case 3:
            try:
                ...
                consulta = f""" SELECT * FROM petshop WHERE pet_id = {pet_id}"""
                ...
                if len(lista_dados) == 0:  # se não há o id
                    ...
                    alteracao = f"""
                        ...
                        nome_pet='{novo_nome}', idade='{nova_idade}' WHERE pet_id={pet_id}
                    """
        ...
        case 4:
            ...
            if pet_id.isdigit():
                ...
                if len(lista_dados) == 0:
                    ...
                    exclusao = f"DELETE FROM petshop WHERE pet_id={pet_id}"
        ...
        case 5:
            ...
            if confirma.upper() == "S":
                ...
                data_reset_ids = """ ALTER TABLE petshop
                                    MODIFY(pet_id GENERATED AS IDENTITY (START WITH 1)) """
